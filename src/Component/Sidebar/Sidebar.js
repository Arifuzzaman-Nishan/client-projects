...
export default function Sidebar() {
    ...
    return (
        <div>
            <div style={{ width: '256px', height:'100vh', background:'#001137' }}>
                  ...
                  <ul className="list-item">
                    {
                      sidebarData.map((item,index) => (
                        ...
                        <li key={index} className="text-white list-design p-2 mb-3 list-background-color" onClick={() => handleBackground(item.title)}>
                      ...
                      <li key={index} className="text-white list-design pb-2 mb-3" onClick={() => handleBackground(item.title)}>
              ...
              <footer >
                  <div style={{height:'15vh'}} className="d-flex align-items-end justify-content-center">
                  ...
                  <div className=" mt-5 d-flex justify-content-around">
                    {
                      footerIcon.map((item,index) => (
                        <img key={index} className="" style={{width:'1.7rem'}} src={item} alt="" />
                      ))
                    }
                  </div>
              </footer>
